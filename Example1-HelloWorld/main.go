package main 
/* 
Here "main" is the file name i.e. main.go
main package declaration is must in a file that has to executable.
A package is a shared library i.e. collection of source files in the same directory that are compiled together.
*/
